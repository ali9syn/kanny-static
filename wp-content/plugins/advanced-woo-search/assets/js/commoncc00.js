        ...
        var methods = {
            ...
            showResults: function( response ) {
                ...
                if ( ( typeof response.products !== 'undefined' ) && response.products.length > 0 ) {
                    ...
                    if ( d.showMore ) {
                        html += '<li class="aws_result_item aws_search_more"><a href="" disabled>' + translate.showmore + '</a></li>';
                    }

                    //html += '<li class="aws_result_item"><a href="" disabled>Next Page</a></li>';
